...
'''
    ...
    $ bash
    $ LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/qin/lib64/
...
for s in range(len(subjects)):
    for t in range(len(tasks)):
        ...
        year = '20'+subject[0:2]
        path = '/home/%s/%s/fmri/%s/AROMA_%s/'%(year,subject,tasks[t],which_aroma)
        #print(path)
        try:
